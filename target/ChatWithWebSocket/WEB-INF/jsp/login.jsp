    ...
    <div class="row" style="margin-top: 10%;">
        <div class="col-md-offset-3 col-md-6">
            <form class="form-horizontal">
                <span class="heading">Đăng nhập người dùng</span>
                <div class="form-group">
                    <input type="text" class="form-control" id="userName" placeholder="Username" maxlength="20">
                    <i class="fa fa-user"></i>
                </div>
                <div class="form-group help">
                    <input type="password" class="form-control" id="password" placeholder="Password" maxlength="20">
                ...
                <div class="form-group">
                    <span class="text"><a href="register">Register</a></span>
                    <button type="button" class="btn btn-default" id="userLogin">Login</button>
                </div>
                <div class="form-group">
